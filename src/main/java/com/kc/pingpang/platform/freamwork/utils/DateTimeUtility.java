...
public class DateTimeUtility {
    ...
    static enum DateFormatType {
    	YYYYMM("yyyy-MM"),
        YYYYMM_CHINESE("yyyy年MM月"),
        
        YYYYMMDD("yyyy-MM-dd"),
        YYYYMMDD_SLASH("yyyy/MM/dd"),
        YYYYMMDD_NO_SEPARATOR("yyyyMMdd"),
        YYYYMMDD_CHINESE("yyyy年MM月dd日"),
        
        YYYYMMDDHHMM("yyyy-MM-dd HH:mm"),
        
    	YYYYMMDDHHMMSS("yyyy-MM-dd HH:mm:ss"),
    	YYYYMMDDHHMMSS_NO_SEPARATOR("yyyyMMddHHmmss"),	// 20091227091010
        
    	MMDD_CHINESE("MM月dd日"),
    	MMDD_POINT("MM.dd"),

        MMDDHHMM("MM-dd HH:mm"),
        MMDDHHMM_POINT("MM.dd HH:mm"),

        DDHHMMSS_NO_SEPRATOR("ddHHmmss"),
    ...
    // 将时间按配置的格式转换为String
    public static String formatYYYYMMDDHHMMSSWithNoSeparator(Date date) {
        if (date == null) {
            return "";
        }
        
        return getDateFormat(DateFormatType.YYYYMMDDHHMMSS_NO_SEPARATOR).format(date);
    }
    ...
    public static String formatYYYYMMWithChinese(Date date) {
        if (date == null) {
            return "";
        }
        
        return getDateFormat(DateFormatType.YYYYMM_CHINESE).format(date);
    }
    ...
    public static String formatYYYYMMDDWithNoSeparator(Date date){
        if (date == null) {
            return "";
        }
        
        return getDateFormat(DateFormatType.YYYYMMDD_NO_SEPARATOR).format(date);
    }
    
    public static String formatYYYYMMDDWithChinese(Date date){
        if (date == null) {
            return "";
        }
        
        return getDateFormat(DateFormatType.YYYYMMDD_CHINESE).format(date);
    }
    ...
    public static String formatYYYYMMDDWithSlash(Date date) {
        if (date == null) {
            return "";
        }
        
        return getDateFormat(DateFormatType.YYYYMMDD_SLASH).format(date);
    }
    
    public static String formatDDHHMMSSWithNoSeparator(Date date) {
        if (date == null) {
            return "";
        }
        
        return getDateFormat(DateFormatType.DDHHMMSS_NO_SEPRATOR).format(date);
    }
    ...
    public static String formatMMDDHHMMWithPoint(Date date) {
        if (date == null) {
            return "";
        }

        return getDateFormat(DateFormatType.MMDDHHMM_POINT).format(date);
    }

    public static String formatMMDDWithChinese(Date date) {
        if (date == null) {
            return "";
        }
        
        return getDateFormat(DateFormatType.MMDD_CHINESE).format(date);
    }

    public static String formatMMDDWithPoint(Date date) {
        if (date == null) {
            return "";
        }

        return getDateFormat(DateFormatType.MMDD_POINT).format(date);
    }
    ...
    // 将时间String转换为Date对象
    public static Date parseYYYYMMDDHHMMSSWithNoSeparator(String date) throws ParseException {
        if (date == null) {
            return null;
        }
        
        return getDateFormat(DateFormatType.YYYYMMDDHHMMSS_NO_SEPARATOR).parse(date);
    }
    ...
    public static Date parseYYYYMMDDWithSlash(String date) throws ParseException {
        if (date == null) {
            return null;
        }
        
        return getDateFormat(DateFormatType.YYYYMMDD_SLASH).parse(date);
    }
    
    public static Date parseYYYYMM(String date) throws ParseException{
    	if(date == null){
    		return null;
    	}
    	
    	return getDateFormat(DateFormatType.YYYYMM).parse(date);
    }
